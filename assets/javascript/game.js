...
$(document).ready(function() {
	...
	function newGame() {
		newNumbers();
		totalScore = 0;
		$("#magicNumber").text(magicNumber); //.text() method is a string containing the combined text of all matched elements.
		$("#totalScore").text(totalScore);
		$("#crystal1").attr("data-crystalvalue", crystal1Num); //.attr() method gets the attribute value for only the first element in the matched set.
